...
{
    public class ModeloEmUsoConfiguracao
    {
        ...
        [JsonConstructor]
        public ModeloEmUsoConfiguracao(string nomeModelo, TipoModelo tipo, string caminhoPasta, string versao, DateTime criadoEm, DateTime atualizadoEm, string schemaVersao, string pipelineVersao, string transformadoresVersao)
        {
        ...
        public ModeloEmUsoConfiguracao(string nomeModelo, TipoModelo tipo, string caminhoPasta)
        {
            NomeModelo = nomeModelo;
            Tipo = tipo;
            CaminhoPasta = caminhoPasta;
