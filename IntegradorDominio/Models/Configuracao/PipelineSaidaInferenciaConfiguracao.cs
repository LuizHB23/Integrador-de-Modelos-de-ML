...
{
    public class PipelineSaidaInferenciaConfiguracao : IListaConfiguracao, IPipelineConfiguracao
    {
        ...
        public PipelineSaidaInferenciaConfiguracao(string nomeModelo, string versao, Dictionary<int, Pipeline> scriptCodigo)
        {
