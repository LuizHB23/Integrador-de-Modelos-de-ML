...
Também é possível encadear funções uma atrás da outra, como por exemplo

```text
LimpezaColunas()
{
df = df.Converter(col="GastoTotal", type="single").Converter(col="GastoMensal", type="single").Converter(col="TaxaDevolucao", type="single")
